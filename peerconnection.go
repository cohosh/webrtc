...
func (pc *PeerConnection) CurrentLocalDescription() *SessionDescription {
	return populateLocalCandidates(pc.log, pc.currentLocalDescription, pc.pendingLocalDescription, pc.iceGatherer, pc.ICEGatheringState())
}
...
func (pc *PeerConnection) PendingLocalDescription() *SessionDescription {
	return populateLocalCandidates(pc.log, pc.pendingLocalDescription, pc.pendingLocalDescription, pc.iceGatherer, pc.ICEGatheringState())
}
